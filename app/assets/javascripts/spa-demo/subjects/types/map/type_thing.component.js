(function() {
    ...
    angular
      ...
      .component("sdTypeThingMap", {
        template: "<div id='map'></div>",
        controller: TypeThingMapController,
        bindings: {
          zoom: "@"
        }
      });
    
    TypeThingMapController.$inject = ["$rootScope", "$scope", "$q", "$element",
    ...
    function TypeThingMapController($rootScope, $scope, $q, $element, 
      ...
      vm.$onInit = function() {
        console.log("TypeThingMapController",$scope);
      }
      vm.$postLink = function() {
        ...
        $scope.$watch(
          function(){ return typeThing.getCurrentImage(); }, 
          function(link) { 
            if (link) { 
        ...
        $scope.$watch(
          ...
          function(marker) { 
            if (marker) {
              ...
              typeThing.setCurrentSubjectId(marker.thing_id, marker.image_id);
            }
          }); 
        $scope.$watch(
    ...
    TypeThingMapController.prototype.updateOrigin = function() {
    ...
    TypeThingMapController.prototype.setActiveMarker = function(thing_id, image_id) {
      if (!this.map) { 
        return; 
    ...
    TypeThingMapController.prototype.originInfoWindow = function(location) {
    ...
    TypeThingMapController.prototype.thingInfoWindow = function(ti) {
    ...
    TypeThingMapController.prototype.imageInfoWindow = function(ti) {
